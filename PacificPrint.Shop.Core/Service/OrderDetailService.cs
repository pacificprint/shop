...
{
    public class OrderDetailService : EntityServiceBase<OrderDetail, Guid>, IOrderDetailService
    {
        private readonly ICurrentUser _currentUser;

        public OrderDetailService(IUnitOfWork unitOfWork, ICurrentUser currentUser) : base(unitOfWork)
        {
