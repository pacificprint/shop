...
{
    public class OrderService : EntityServiceBase<Order, Guid>, IOrderService
    {
        private readonly ICurrentUser _currentUser;

        public OrderService(IUnitOfWork unitOfWork, ICurrentUser currentUser) : base(unitOfWork)
        {
